...
public class ManagerScript : MonoBehaviour
{
    ...
    void Start()
    {
        // Whenever the value of rotslider changes it will call the function RotationValueChange
    ...
    // Function to allow the user to hide or show this menu
    ...
    // Function to allow the user to select a load menu
    ...
    // Function to allow the user to select a cylinder
    ...
    // Function to allow the user to select a cube
    ...
    // Function to allow the user to select a spheere
    ...
    // Function to allow the user to select a player to place him
    ...
    // Options Menu, different actions that may be taken by the user
    // Function to allow the user to create an object
    ...
    // Function to allow the user to rotate an object
    ...
    // Function to allow the user to destroy an object
    ...
    // Function to save the objects to a json file, it will create the file if necessary
